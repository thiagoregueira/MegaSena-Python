...
# lêr o arquivo excel mega_sena_asloterias_ate_concurso_2737_sorteio.xlsx
# df_excel = pd.read_excel("mega_sena_asloterias_ate_concurso_2737_sorteio.xlsx")
...
with col1:
    ...
    st.dataframe(
        df_filtrado_datas.sort_values(by="Data", ascending=False), hide_index=True
    )
